...
class _EmpireUpgrades(type):
	_UPGRADES = [
		_Upgrade(db_col="extra_money_units", display_name="Money Maker Slots", base_cost=12_500),
		_Upgrade(db_col="extra_military_units", display_name="Military Slots", base_cost=10_000, max_amount=15),
		...
		_Upgrade(db_col="cheaper_money_units", display_name="Cheaper Money Makers", base_cost=10_000, max_amount=10),
		_Upgrade(db_col="cheaper_military_units", display_name="Cheaper Military", base_cost=15_000, max_amount=10),
	]
